...
const PatientSettings = () => {
    ...
    useEffect(() => {
        ...
        if (savedState) {
            ...
            Promise.all([patientData, accountData]).then((values)=>{
                    ...
                    {editingPersonal && 
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col}>
                                ...
                                <Form.Control placeholder={userData.firstName} value={firstName} onChange={(e)=>{setFirstName(e.target.value)}} required/>
                            </Form.Group>
                            
                            <Form.Group as={Col}>
                                <Form.Label>Last Name</Form.Label>
                                <Form.Control placeholder={userData.lastName} value={lastName} onChange={(e)=>{setLastName(e.target.value)}} required/>
                            </Form.Group>
                        </Row>
                        ...
                        <Row className="mb-3">
                            ...
                            <Form.Group as={Col}>
                                <Input type="date" name="date" placeholder={userData.dateOfBirth} value={dateOfBirth} onChange={(e)=>{setDateOfBirth(e.target.value)}} required/>
                            </Form.Group>
                        </Row>
                        ...
                        <Row className="mb-3">
                            ...
                            <Form.Group as={Col}>
                            <Form.Select placeholder={userData.gender} value={gender} onChange={(e)=>{setGender(e.target.value)}} required>
