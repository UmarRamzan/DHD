...
router.post('/api/general/validateBooking', generalController.validateBooking)
...
router.post('/api/patient/getPatientName', patientController.getPatientName)
...
router.post('/api/doctor/getDoctorName', doctorController.getDoctorName)
...
router.post('/api/hospital/getHospitalName', hospitalController.getHospitalName)
